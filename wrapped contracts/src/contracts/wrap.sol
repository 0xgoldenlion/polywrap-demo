...
contract WRAP is ERC721URIStorage, Ownable {
    ...
    string private _tablePrefix = "WRAP";
    // someday we update this with a nuxt app that diplays x,y and
    // gives you the interface to move x,y.
    string private _externalURL = "WRAP.me";
    string private _image =
        "https://bafybeiaviawldouv7lp6v44civfqco752nzme64rtaqaang3rfgm4y5mym.ipfs.nftstorage.link/";

    constructor(address registry) ERC721("WRAP", "WRAP") {
